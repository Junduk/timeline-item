...
const App = () => {
  ...
  let items = [{id: 1, start: 10, end: 21.54, content: 'Event 2 for Pedestrians', gain: 0.85, group: 1},
  ...
  if(sortValue === 'None'){
    ...
    data = applyNonLinearTransformation(items, 1);
  } else if(sortValue === 'Cars'){
    data = applyNonLinearTransformation(items, 2);
  } else if(sortValue === 'Trucks'){
    data = applyNonLinearTransformation(items, 3);
  }
